...
def get_arguments():
    ...
    general.add_argument("--num_gpus", type=int, default=0)
    ...
    general.add_argument("--permutation_test",type=bool, default=True)
    general.add_argument("--permutation_feat",type=str, default="None")
    general.add_argument("--permutation_num",type=int, default=20)
    ...
    data.add_argument("--ds_name", type=str, default="HIV_and_PS_Related_Data_6_6_23/dataset_0918", help="The name of dataset")
    ...
    data.add_argument("--ds_split", type=str, default="train_test_split_large_network1")
    data.add_argument("--num_workers", type=int, default=1, help='The number of workers used for loading data.')
    data.add_argument("--batch_size", type=int, default=256, help="batch size for the graph training")
    data.add_argument("--node_feat_cols", type=str, default="norm_onehot_feats")
    data.add_argument("--node_label_cols", type=str, default="status_cat",
    ...
    model.add_argument("--model", type=str, default="gcn_bn",
                       choices=["mlp", "deepset", "transet", "tabnet", "gcn","gat","gin","gcn_bn"])
    model.add_argument("-n", "--model_num", type=int, default=7, help="The number of model")
    ...
    train.add_argument("--max_epochs", type=int, default=200)
    ...
    train.add_argument('--lr_decay_step_or_patience', type=int, default=25,
