...
def get_arguments():
    ...
    model.add_argument("--model", type=str, default="gcn_bn",
                       choices=["mlp", "deepset", "transet", "tabnet", "gcn","gat","gin","pdglstm","gcn_bn"])
    ...
    train.add_argument("--max_epochs", type=int, default=300)
    ...
    train.add_argument('--lr_decay_step_or_patience', type=int, default=30,
